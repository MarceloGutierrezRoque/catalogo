...
import { createRoute, createStop } from "@/services/routes"
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Crea una nueva ruta con sus paradas asociadas
        </p>
      </div>
      ...
      <div className="rounded-xl border bg-card p-6">
        ...
        {stops.length === 0 ? (
          <div className="py-8 text-center">
            ...
            {errors.stops && (
              <p className="text-sm text-destructive mt-2">{errors.stops}</p>
            )}
          </div>
        ) : (
