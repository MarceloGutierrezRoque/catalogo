...
import { createShipment, createShipmentItem } from "@/services/shipments"
...
export default function NewShipmentPage() {
  ...
  const [formOriginWarehouse, setFormOriginWarehouse] = useState("")
  const [formDestAddress, setFormDestAddress] = useState("")
  const [formDestCity, setFormDestCity] = useState("")
  const [formDestCountry, setFormDestCountry] = useState("")
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const created = await createShipment(shipmentPayload)
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Crea un nuevo envío con sus productos asociados
        </p>
      </div>
